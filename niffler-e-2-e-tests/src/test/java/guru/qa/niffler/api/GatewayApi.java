...
public interface GatewayApi {
    ...
    Call<CategoryJson> addCategory(@Header("Authorization") String authToken,
    ...
    Call<SessionJson> getSession(@Header("Authorization") String authToken);
    ...
    Call<UserJson> getCurrentUser(@Header("Authorization") String authToken);
